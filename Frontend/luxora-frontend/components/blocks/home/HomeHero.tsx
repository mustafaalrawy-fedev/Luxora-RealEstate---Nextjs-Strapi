        ...
        <div className='relative flex justify-center items-center h-full w-full'>
          ...
          <div className="absolute inset-0 bg-black/50 z-10"></div>
            <div className='container-space relative z-20 text-center'>
                <h1 className="">Luxora</h1>
                <p className="max-w-lg text-lg mx-auto">Premium real estate designed for those who seek sophistication, exclusivity, and timeless value.</p>
                {/* CTA Buttons */}
