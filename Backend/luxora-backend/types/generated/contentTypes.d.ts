...
export interface ApiAmenityAmenity extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    amenity_image: Schema.Attribute.Media<'images'> &
      Schema.Attribute.Required &
    ...
    amenity_name: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.Unique &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
    ...
    category: Schema.Attribute.Enumeration<
      ['Indoor', 'Outdoor', 'Services', 'Smart', 'Leisure']
    > &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
    ...
    slug: Schema.Attribute.UID<'amenity_name'> &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
...
export interface ApiCityCity extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    slug: Schema.Attribute.UID<'city_name'> &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
...
export interface ApiCountryCountry extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    >;
    publishedAt: Schema.Attribute.DateTime;
    slug: Schema.Attribute.UID<'country_name'> &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
...
export interface ApiInquiryInquiry extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    >;
    buyers: Schema.Attribute.Relation<
      'oneToMany',
      'plugin::users-permissions.user'
    >;
    createdAt: Schema.Attribute.DateTime;
    ...
    property: Schema.Attribute.Relation<'oneToMany', 'api::property.property'>;
    publishedAt: Schema.Attribute.DateTime;
    subject: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
...
export interface ApiPropertyTypePropertyType
  ...
  attributes: {
    ...
    >;
    publishedAt: Schema.Attribute.DateTime;
    slug: Schema.Attribute.UID<'type_name'> &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
    ...
    type_name: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.Unique &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
...
export interface ApiPropertyProperty extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    area_size_sqft: Schema.Attribute.Integer &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
    ...
    construction_status: Schema.Attribute.Enumeration<
    ...
    property_status: Schema.Attribute.Enumeration<['Sale', 'Rent', 'Sold']> &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
    ...
    slug: Schema.Attribute.UID<'property_name'> &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
